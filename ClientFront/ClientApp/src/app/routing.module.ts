...
import { PrivateLayoutComponent } from "./pages/layout/private-layout/layout.component";
...
const appRoutes: Routes = [
  {
    ...
    children: [
      ...
      { path: "messages", loadChildren: () => import('./pages/controlPanel/messages/message.module').then(m => m.MessagesModule), canActivate: [AuthenticateGuard] },
